...
Prepare soil parameterisation (e.g. for meso-scale hydrological modelling with [WASA-SED](https://github.com/TillF/WASA-SED) in conjunction with [lumpR](https://github.com/tpilz/lumpR) ), using the global datasets [SoilGrids](https://soilgrids.org/) and Pelletier et al. (2016). Pedotransfer functions from other packages ```(ptf.rawls{soilwaterptf}, euptf{euptf})``` are applied to calculate soil characteristics.
